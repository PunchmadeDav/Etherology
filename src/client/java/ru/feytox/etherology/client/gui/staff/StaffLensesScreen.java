...
import ru.feytox.etherology.client.mixin.KeyBindingAccessor;
import ru.feytox.etherology.client.mixin.StickyKeyBindingAccessor;
...
public class StaffLensesScreen extends Screen {
    ...
    private List<LensWidget> createLensWidgets(MinecraftClient client) {
        List<ItemStack> stacks = getPlayerLenses(client);
