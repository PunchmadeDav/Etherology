...
public class ModelGeneration extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator generator) {
        ...
        // simple items
        registerItems(generator, Models.GENERATED, AZEL_INGOT, AZEL_NUGGET, EBONY_INGOT, EBONY_NUGGET, ETHRIL_INGOT, ETHRIL_NUGGET, BEAM_FRUIT, BEAMER_SEEDS, OCULUS, CORRUPTION_BUCKET, THUJA_OIL, THUJA_SEEDS, ETHEROSCOPE, RAW_AZEL, ATTRAHITE_BRICK, ENRICHED_ATTRAHITE, BINDER, ETHEREAL_CHANNEL, ETHEREAL_FORK, REVELATION_VIEW, EBONY, FOREST_LANTERN, FOREST_LANTERN_CRUMB, PEACH_BOAT, PEACH_CHEST_BOAT);
    ...
    private static void registerStaffParts(ItemModelGenerator generator) {
        StaffPartInfo.generateAll().forEach(partInfo -> {
            ...
            EtherologyModels.getStaffPartModel(partInfo).upload(StaffModel.toModelId(partInfo).id(), textures, generator.writer);
        });
    }
